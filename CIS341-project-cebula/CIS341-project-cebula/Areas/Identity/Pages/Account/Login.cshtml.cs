    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                UserAccount userAccount = _dataBitesContext.Users.Where(x => x.UserAccountId == user.UserAccountId).FirstOrDefault();
                if (userAccount.Suspended)
                {
                    ModelState.AddModelError(string.Empty, "This user is suspended!");
                    return Page();
                }
